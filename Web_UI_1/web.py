...
#rb_model = load_model('/mnt/c/Users/Room201B/Documents/Salem - Thesis/Saved Models/Rice Bran/set3_rb_resnet_9.h5')
rb_model = load_model('C:\\Users\\hp\\Documents\\VSU Files\\Fourth Year\\Thesis\\Program\\Saved Models\\Rice Bran\\set3_rb_resnet_9.h5')

# Predict Model
rb_model.make_predict_function()
...
def predict_label(img_path):
    ...
    # Make a prediction
    prediction = rb_model.predict(img_array)
...
def get_output():
    ...
    p = None  # Initialize p to None (or some other default)
